    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">智能教学平台</h1>
          <p className="text-gray-600 font-medium">欢迎登录</p>
        </div>

        {/* 登录表单 */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-6 md:p-8 border border-white">
